...
const initialState = {
  // initial state of to do yha initial state declear kie hai
...
export const todoSlice = createSlice({
  ...
  initialState,
  reducers: {
    // iske andaar property aata hai and ek function aata hai
    ...
    removeTodo: (state, action) => {
      // state k andar jo v current state hai wo milta hai and action k andar jo v adata pass hua hai wo milta hai
